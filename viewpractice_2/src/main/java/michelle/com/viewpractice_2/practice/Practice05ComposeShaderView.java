...
public class Practice05ComposeShaderView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Shader shader2 = new LinearGradient(200,0,200,500, Color.parseColor("#00000000"),Color.parseColor("#00FF00"), Shader.TileMode.CLAMP);

        Shader composeShander = new ComposeShader(shader1,shader2,
                PorterDuff.Mode.SRC_OVER);

        paint.setShader(composeShander);
